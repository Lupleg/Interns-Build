    ...
    <div className='py-8  mx-auto bg-gradient-to-br from-cyan-400 via-zinc-50 to-red-300 pb-12'>
      <div className='flex flex-wrap justify-between items-center h-14 w-11/12 lg:w-3/5 mx-auto '>
        <div className='flex flex items-center h-full min-w-max'>
          ...
          <a href="#"><h1 className='text-xl font-medium'>Front Help Center</h1></a>
        </div>

        <div className='ml-4  flex items-center h-full'>
          <div>
            <button className='hover:bg-gray-200 w-32 px-2 rounded-full py-1 font-medium'>Login to Front</button>
          </div>
          <div>
            <button className='text-white bg-blue-900 rounded-full py-1 px-2 w-28 ml-2 font-medium'>Contact us</button>
          </div>
        </div>
      </div>
