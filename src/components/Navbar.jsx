...
const Navbar = ({ isOpen, toggleMenu }) => {
  ...
  return (
    <div className="sticky top-0 bg-white z-50 shadow-md">
      <div className="flex justify-between  w-4/5  lg:w-4/5 mx-auto">
        ...
        <div className="lg:hidden">
          <Hamburger toggled={isOpen} toggle={handleHamburgerClick} size={30} />
        </div>
      ...
      <div className="lg:hidden w-4/5 mx-auto mt-4">
        {isOpen && (
