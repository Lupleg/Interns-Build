...
const Connect = () => {
  return (
    <div>
      ...
      <div>
        <div className="grid grid-cols-1 gap-10 w-4/5 mx-auto bg-gray-100 rounded-lg p-4 lg:grid-cols-2 xl:grid-cols-3 px-20 py-14">
          ...
          <div className="p-8 bg-white rounded-lg drop-shadow-lg xl:col-span-3">
        ...
        <div className="text-center w-4/5 mx-auto bg-gray-100 rounded-lg py-10 pd-20 flex flex-col justify-center align-center">
